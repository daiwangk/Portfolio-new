...
/** Detect what label to show based on the hovered element */
...
export default function CustomCursor() {
  ...
  useEffect(() => {
    ...
    // Lerp ring toward mouse on every GSAP tick
    const tick = () => {
    ...
    const onOver = (e: MouseEvent) => {
      const interactive = (e.target as Element)?.closest('a, button, [data-cursor], [data-magnetic]')
    ...
    const onOut = (e: MouseEvent) => {
      ...
      if (related && (related as Element).closest?.('a, button, [data-cursor], [data-magnetic]')) return
  ...
  return (
    <div
      ...
      style={{
        ...
        borderRadius: '50%',
        background: 'white',
        // Difference blend: cursor inverts whatever is behind it
